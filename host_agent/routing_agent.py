    ...
    def _format_response(self, parts: List[Any]) -> str:
        ...
        try:
            ...
            if agent_type in ("symptom", "cost", "symptom_cost", "booking", "general"):
                ...
                Nếu không có hoặc trống → bạn dựa theo dữ liệu sau mà tôi cung cấp để đưa ra giá hợp lý dựa trên triệu chứng bệnh và tên bệnh trong câu trả lời của symtomp agent và user của người và bảng giá dữ liệu sau:
                   - GÓI KHÁM TỔNG QUÁT CƠ BẢN : 4.000.000 Đồng
                   - GÓI 2: GÓI KHÁM TỔNG QUÁT NÂNG CAO: 7.000.000đ (Nam)
                   ...
                   - GÓI KHÁM TỔNG QUÁT TIÊU CHUẨN THỨ 7 : 3.500.000 Đồng
                   - GÓI CT - SCAN 	Chụp CLVT hàm-mặt có tiêm thuốc cản quang (sọ + xoang) (chưa bao gồm thuốc cản quang) [BHYT thanh toán theo đơn giá 1-32 dãy]:1,950,000
                   - GÓI Chụp CLVT sọ não không tiêm thuốc cản quang [BHYT thanh toán theo đơn giá 1-32 dãy]: 1.000.000đ
                    🔹 Ví dụ:
                    Chi phí khám tổng quát tiêu hóa thông thường khoảng 2.500.000 đến 3.500.000.
